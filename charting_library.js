(function (t, e) {
   ...
   const r = class {
      ...
      resetLayoutSizes(t) {
         this._innerAPI().resetLayoutSizes(t);
      }
      changeTheme(t, e) {
            ...
            this._innerWindowLoaded.then(() => {
               try {
                  ...
                  if (
                     ...
                     throw new Error(
                        `There was an error when loading the library. Usually this error means the library failed to load its static files. Check that the library files are available at ${window.location.host
      ...
      _render(t) {
               ...
               l = `\n${(function (t, e, n) {
                  ...
                  for (const s of t)
                     s.endsWith(".js")
                        ...
                        : s.endsWith(".css") &&
                        o.push(
                           `<link type="text/css" href="${e ? s.replace(/\.css$/i, ".rtl.css") : s
                           }" rel="stylesheet"/>`
                        );
                  return [...i, ...o].join("\n");
               })(s, "rtl" === a.dir, r)}\n`;
            return `<!DOCTYPE html><html ${(h = { bundles: l, localeLanguage: r, htmlAttrs: d, libraryPath: o })
               .htmlAttrs
               }><head><base href="${h.libraryPath
               }"><meta charset="utf-8"><script>window===window.parent&&(location.href="about:blank")<\/script> ${h.bundles
         ...
         const s =
            ...
            (this._options.time_scale
               ...
               : "");
         return [
            `<iframe\n\t\tid="${this._id}" name="${this._id}" src="${o.href
